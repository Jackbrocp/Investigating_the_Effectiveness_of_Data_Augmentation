...
def do_transform(data_augmentation=None, args=None):
    ...
    elif data_augmentation == 'randomerasing_fixed':
        return RandomErasing_fixed(length=int(args[0]))
...
def make_transform(data_augmentation=None, dataset_name='CIFAR10',  to3channels=False, model=None):
    # print(aug_list)
    ...
    for item in aug_list:
        ...
        elif method in ['randomerasing_fixed', 'cutout', 'randomerasing', 'gridmask', 'has', 'crop']:
        ...
        elif method in ['basic','keepaugment','mixup','cutmix']:
...
if __name__ == '__main__':
    ...
    t = make_transform('randomerasing_fixed(60)')
    print(t)
